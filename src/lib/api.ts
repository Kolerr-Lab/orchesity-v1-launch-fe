...
class ApiService {
  ...
  private async request<T>(
    ...
    const mockResponses: Record<string, any> = {
      ...
      '/users': {
        data: [
          { id: '1', email: 'admin@orchesity.com', name: 'Admin User', role: 'admin', createdAt: '2024-01-01T00:00:00Z' },
          { id: '2', email: 'user@orchesity.com', name: 'John Doe', role: 'user', createdAt: '2024-01-01T00:00:00Z' }
        ]
      },
      '/logs': {
        data: [
